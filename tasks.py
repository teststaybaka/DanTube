    ...
    def get(self):
        ...
        while True:
            ...
            for t in tasks:
                ...
                if data['kind'] == 'hit':
                    video['hit'] = True
                    video['hotscore'] = video['hotscore']*99/100 + models.time_to_seconds(t.eta.replace(tzinfo=None))/100
        ...
        for clip_id in clips:
            ...
            if danmaku_list:
                try:
                    ...
                    danmaku_list = json.loads(pool.read()) + [danmaku.format() for danmaku in danmaku_list]
                    pool.close()
            ...
            if advanced_danmaku_list:
                try:
                    ...
                    advanced_danmaku_list = json.loads(pool.read()) + [danmaku.format() for  danmaku in advanced_danmaku_list]
                    pool.close()
                except gcs.NotFoundError:
                    pass
